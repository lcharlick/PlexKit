...
public extension Plex {
    @discardableResult func publisher<Request: PlexServiceRequest>(
        _ request: Request,
        token: String? = nil
    ) -> AnyPublisher<Request.Response, PlexError> {
        let urlRequest: URLRequest
    ...
    @discardableResult func publisher<Request: PlexResourceRequest>(
        _ request: Request,
        from url: URL,
        token: String? = nil
    ) -> AnyPublisher<Request.Response, PlexError> {
